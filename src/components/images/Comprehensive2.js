...
function Comprehensive2() {
  return (
    <section className='container-fluid'>
        <div className='row gy-3'>
            <div className='title col-12 mt-5'>
                <h1 className='ESS'>Expression</h1>
                <div className='divider'></div>
            </div>
            <div className='col-md-6 col-sm-6 bg-light' >
                <img  src={teacher} alt='' className='img-fluid mt-2'/>
            </div>
            <div className='col-md-6 col-sm-6 myExp'>
                <h1 className='trust'>Our Comprehensive Teaching</h1>
                    <p className='trs'> <span className='span'>A</span>dvance your career with our top Executive Education programs. Request a program guide.
                    ...
                    <p className='trs'> <span className='span'>O</span>pen programmes. We will test you, challenge you, encourage you and inspire you.
                    ...
                    <p className='trs'> <span className='span'>T</span>op-Ranked Business School Delivering World-Class Exec Programs.
